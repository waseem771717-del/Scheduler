...
import { Mail, Lock, ArrowRight, AlertCircle, CheckSquare } from 'lucide-react';
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 text-sm mt-2 text-center max-w-xs">
            Unlock your productivity potential. Track tasks, schedules, and weekly routine progress.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex justify-between items-center">
              ...
              <Link
                to="/forgot-password"
                className="text-[11px] font-bold text-fuchsia-400 hover:text-fuchsia-300 transition-colors"
              >
                Forgot Password?
              </Link>
            </div>
